...
class PersonaRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'telefono_2'    => 'required|string|max:12|min:12',
            ...
            'beneficiario_mision'           => 'required|string|max:255',
            'beneficiario_mision_descripcion' => 'required|string|max:255',
            ...
            'liceo_universidad'             => 'required|string|max:255',
            'carrera'                       => 'required|string|max:255',
            'lugar_trabajo'                 => 'required|string|max:255',
            'ocupacion'                     => 'required|string|max:255',
            'potencialidad'                 => 'required|string|max:255',
